...
from estimator.cycles.graph import ClockCyclesKernelGraph
...
def main(args: Dict[str, Any]):
    ...
    anchor_dict = {bench: ClockCyclesKernelGraph(bench) for bench in BENCHMARKS}
...
def parse_args():
    ...
    parser.add_argument("-o", "--output-dir", default="estimator/cycles/dataset/raw",
