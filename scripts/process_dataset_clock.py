...
from estimator.clock.graph import ClockPeriodKernelGraph
...
def main(args: Dict[str, Any]):
    ...
    anchor_dict = {bench: ClockPeriodKernelGraph(bench) for bench in BENCHMARKS}
...
def parse_args():
    ...
    parser.add_argument("-o", "--output-dir", default="estimator/clock/dataset/raw",
