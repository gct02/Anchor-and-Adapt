...
from estimator.power.graph import PowerKernelGraph
...
def main(args: Dict[str, Any]):
    ...
    anchor_dict = {bench: PowerKernelGraph(bench) for bench in BENCHMARKS}
...
def parse_args():
    ...
    parser.add_argument("-o", "--output-dir", default="estimator/power/dataset/raw",
