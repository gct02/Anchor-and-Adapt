...
from estimator.mtl.graph import MultiTaskKernelGraph
...
def main(args: Dict[str, Any]):
    ...
    anchor_dict = {bench: MultiTaskKernelGraph(bench) for bench in BENCHMARKS}
...
def parse_args():
    ...
    parser.add_argument("-o", "--output-dir", default="estimator/mtl/dataset/raw",
