...
if __name__ == "__main__":
    ...
    def parse_arguments() -> Dict[str, Any]:
        parser = argparse.ArgumentParser(
            description='Pre-train estimator to infer the Dynamic Power of HLS designs.'
        )
        parser.add_argument('-t', '--test-bench', type=str, required=True,
                            help='Name of the benchmark to use for testing.')
        parser.add_argument('-d', '--dataset-dir', type=str, default='estimator/power/dataset',
                            help='Dataset root directory. Default: \'estimator/power/dataset\'.')
    ...
    train_loader, test_loader = prepare_train_test_loaders(
        PowerDataset, dataset_dir, test_bench, 
