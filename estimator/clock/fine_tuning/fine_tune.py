...
from estimator.clock.train import (
    evaluate_ensemble, 
    evaluate,
    export_eval_results
)
...
def main(args: Dict[str, str]):
    ...
    train_loader = prepare_loader(
        ClockPeriodDataset, dataset_dir, benchmark, 
    ...
    test_loader = prepare_loader(
        ClockPeriodDataset, train_dataset_dir, benchmark, 
    ...
    freeze_prefixes = [
        'proj_lin.', 'proj_norm.', 'convs.0.', 'norms.0.'
    ]
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Fine-tune a pre-trained Clock Period estimator")
    parser.add_argument("model_dir", type=str, 
                        help="Path to the pre-trained model directory.")
    parser.add_argument("-d", "--dataset-dir", type=str, default="estimator/common/fine_tuning/samples/clock/dataset", 
    ...
    parser.add_argument("--train-dataset-dir", type=str, default="estimator/clock/dataset",
