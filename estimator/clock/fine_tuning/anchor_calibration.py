...
from estimator.clock.train import export_eval_results, evaluate_ensemble, METRIC_NAME
...
def main(args: Dict[str, str]):
    ...
    train_dataset_dir = args.get("train_dataset_dir", "estimator/clock/dataset")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--train-dataset-dir", type=str, default="estimator/clock/dataset",
