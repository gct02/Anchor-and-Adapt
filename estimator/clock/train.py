...
if __name__ == "__main__":
    ...
    def parse_arguments() -> Dict[str, Any]:
        parser = argparse.ArgumentParser(
            description='Pre-train estimator to infer the Clock Period of HLS designs.'
        )
        ...
        parser.add_argument('-d', '--dataset-dir', type=str, default='estimator/clock/dataset',
                            help='Dataset root directory. Default: \'estimator/clock/dataset\'.')
    ...
    train_loader, test_loader = prepare_train_test_loaders(
        ClockPeriodDataset, dataset_dir, test_bench, 
