...
from estimator.cycles.train import evaluate_ensemble, export_eval_results
...
if __name__ == "__main__":
    ...
    if target_model_dir is None:
        model_dirs = Path("estimator/cycles/models").iterdir()
    else:
    ...
    for model_dir in model_dirs:
        ...
        loader = prepare_loader(
            ClockCyclesDataset, dataset_dir, [benchmark], batch_size=batch_size
        )
