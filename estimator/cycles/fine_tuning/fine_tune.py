...
from estimator.cycles.train import (
    evaluate_ensemble, 
    evaluate,
    export_eval_results
)
...
def main(args: Dict[str, str]):
    ...
    train_loader = prepare_loader(
        ClockCyclesDataset, dataset_dir, benchmark, 
    ...
    test_loader = prepare_loader(
        ClockCyclesDataset, train_dataset_dir, benchmark, 
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Fine-tune a pre-trained Clock Cycles estimator")
    parser.add_argument("model_dir", type=str, 
                        help="Path to the pre-trained model directory.")
    parser.add_argument("-d", "--dataset-dir", type=str, default="estimator/common/fine_tuning/samples/cycles/dataset", 
    ...
    parser.add_argument("--train-dataset-dir", type=str, default="estimator/cycles/dataset",
